...
exports.getCourse = asyncHandler(async (req, res, next) => {
    ...
    if(!course) {
        return next(new ErrorResponse(`No course id found with id: ${req.params.id}`, 404));
    }
...
// @desc     Create course
// @route    GET /api/v1/bootcamps/:boodcampId/courses
// @access   Private
exports.addCourse = asyncHandler(async (req, res, next) => {
    ...
    // Make sure the user is the bootcamp owner and not admin
